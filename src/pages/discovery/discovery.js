	...
	return (
		<>
			...
			{/*	<div className="planet-system">*/}
				...
				{/*		id="planet-system"*/}
				{/*		name="planet-system"*/}
				{/*		value="planets-discovered-by-kepler"*/}
				...
				{/*		id="planet-system"*/}
				{/*		name="planet-system"*/}
				{/*		value="planets-with-host-stars-visible-to-naked-eye"*/}
				{/*		// checked={isChecked} onChange{handleOnChange}*/}
				{/*	/>*/}
				...
				{/*		id="planet-system"*/}
				{/*		name="planet-system"*/}
				{/*		value="planets-within-multiple-planet-systems"*/}
				{/*		// checked={isChecked} onChange{handleOnChange}*/}
				{/*	/>*/}
				...
				{/*	/>*/}
				{/*	<p>Astronomy</p>*/}
				{/*	<input type="checkbox" id="discovery-method" name="discovery-method" value="disk-kinematics"*/}
				{/*		// checked={isChecked} onChange{handleOnChange}*/}
				{/*	/>*/}
				{/*	<p>Disk Kinematics</p>*/}
				{/*	<input type="checkbox" id="discovery-method" name="discovery-method"*/}
				{/*	       value="eclipse-timing-variations"*/}
				{/*		// checked={isChecked} onChange{handleOnChange}*/}
				{/*	/>*/}
				{/*	<p>Eclipse Timing Variations</p>*/}
				{/*	<input type="checkbox" id="discovery-method" name="discovery-method" value="imaging"*/}
				{/*		// checked={isChecked} onChange{handleOnChange}*/}
				{/*	/>*/}
				{/*	<p>Imaging</p>*/}
				{/*	<input type="checkbox" id="discovery-method" name="discovery-method" value="microlensing"*/}
				{/*		// checked={isChecked} onChange{handleOnChange}*/}
				{/*	/>*/}
				{/*	<p>Microlensing</p>*/}
				{/*	<input type="checkbox" id="discovery-method" name="discovery-method"*/}
				...
				{/*	<input type="checkbox" id="discovery-method" name="discovery-method" value="pulsar-timing"*/}
				{/*		// checked={isChecked} onChange{handleOnChange}*/}
				{/*	/>*/}
				{/*	<p>Pulsar Timing</p>*/}
				{/*	<input type="checkbox" id="discovery-method" name="discovery-method"*/}
				{/*	       value="pulsar-timing-variations"*/}
				{/*		// checked={isChecked} onChange{handleOnChange}*/}
				{/*	/>*/}
