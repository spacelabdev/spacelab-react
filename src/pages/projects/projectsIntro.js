	...
	return (
		<div className={"projects-main-container"}>
			...
			<p className={"exoplanetarium-paragraphs"}>
				...
				using various degrees of Machine Learning and Deep Natural Networks in the pursuit of Earth-Like
				planets around nearby stars in the Milky Way Galaxy.
			</p>
			<br/>
			<p className={"exoplanetarium-paragraphs"}>
				Our short-term goal is to find objects on interest for professional Astronomers to explore, and to
				classify already-identified candidates that have not yet been classified as either exoplanets or
