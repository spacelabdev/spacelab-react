...
export const transitPropertiesFiltersArray = [
	...
	},
	{
		...
		default: true,
		dataType: 'number',
		description: 'The time between first and second contact of the planetary transit. Contact times are typically computed from a best-fit model produced by a Mandel-Agol (2002) model fit to a multi-quarter Kepler light curve, assuming a linear orbital ephemeris.',
	},
	{
		name: 'koi_depth',
		label: 'Transit Depth',
	...
	},
	{
		...
		default: false,
		dataType: 'number',
		description: 'Half of the long axis of the ellipse defining a planet\'s orbit. For a circular orbit this is the planet-star separation radius. The semi-major axis is derived based on Kepler\'s third law, i.e., utilizing the orbital period and stellar mass, not scaling the planet-star separation by the stellar radius.',
	},
	{
		name: 'koi_incl',
		label: 'Inclination',
		...
		default: false,
		dataType: 'number',
		description: 'The angle between the plane of the sky (perpendicular to the line of sight) and the orbital plane of the planet candidate.',
	},
	{
		name: 'koi_teq',
	...
	},
	{
		...
		default: false,
		dataType: 'number',
		description: 'Up to four coefficients (a1, a2, a3, a4) that define stellar limb darkening (e.g., Claret 2000). Limb darkening is the variation of specific intensity of the star as a function of μ = cos(θ). θ is the angle between the line-of-sight of an observer and a line perpendicular to the stellar surface at an observed point. Coefficients are dependent upon stellar temperature, surface gravity and metallicity. Adopted coefficients are required input for Mandel-Agol (2002) fits and are extracted from archived tables (e.g., Claret and Bloemen 2011). Limb-darkening coefficients remain fixed during fit minimization. Note that the dependence of limb-darkening coefficients on stellar parameters implies that planet radius does not scale linearly with stellar radius. If new stellar parameters are adopted, the most-correct approach is to re-fit the transit with new limb-darkening coefficients in order to re-measure planet size.',
	},
	{
		name: 'koi_ldm_coeff2',
...
export const thresholdCrossingEventFiltersArray = [
	{
		...
		default: false,
		dataType: 'number',
		description: 'The maximum calculated value of the SES. Maximum SES statistics for different TCEs from the same target differ because the most significant TCE is removed from the time series before repeating the test for further, weaker transit signals.',
	},
	{
	...
	},
	{
		...
		default: false,
		dataType: 'number',
		description: 'The goodness of the transit fit to the data. Within the TCE table, this quantity is the χ2 statistic. Within the KOI table this quantity is the reduced-χ2 statistic, e.g., divided by the number of degrees of freedom in the fit.',
	},
	{
...
export const pixelBasedKoiVettingFiltersArray = [
	{
		...
		default: false,
		dataType: 'number',
		description: 'The Right Ascension (J2000) of the location of the transiting object calculated from the flux-weighted centroids. This result does not reflect the systematics due to crowding which can introduce significant errors in the calculated position.',
	},
	{
		name: 'koi_fwm_sdec',
		...
		default: false,
		dataType: 'number',
		description: 'The Declination (J2000) of the location of the transiting object calculated from the flux-weighted centroids. This result does not reflect the systematics due to crowding which can introduce significant errors in the calculated position.',
	},
	{
		name: 'koi_fwm_srao',
		label: 'FW Δα(OOT)',
		...
		default: false,
		dataType: 'number',
		description: 'The RA (J2000) flux-weighted centroid shift. This is the RA of the in-transit flux weighted centroid minus the RA of the out-of-transit flux weighted centroid.',
	},
	{
		name: 'koi_fwm_sdeco',
		label: 'FW Δδ(OOT)',
		...
		default: false,
		dataType: 'number',
		description: 'The Dec (J2000) flux-weighted centroid shift. This is the Dec of the in-transit flux weighted centroid minus the Dec of the out-of-transit flux weighted centroid.',
	},
	{
		name: 'koi_fwm_prao',
		...
		default: false,
		dataType: 'number',
		description: 'The calculated Right Ascension offset of the transiting or eclipsing object from the KIC location of the target star. The accuracy of this calculation degrades when the transit source has significant flux that falls outside the photometric aperture + a halo of pixels around it.',
	},
	{
		name: 'koi_fwm_pdeco',
		...
		default: false,
		dataType: 'number',
		description: 'The calculated Declination offset of the transiting or eclipsing object from the KIC location of the target star. The accuracy of this calculation degrades when the transit source has significant flux that falls outside the photometric aperture + a halo of pixels around it.',
	},
	{
	...
	},
	{
		...
		default: false,
		dataType: 'number',
		description: 'The angular offset in the RA (J2000) direction between the best-fit PRF centroids from the Out-Of-Transit image and the Difference Image by averaging the weighted single-quarter measurements. The out-of-transit centroids are subtracted from the difference image centroids.',
	},
	{
		name: 'koi_dicco_mdec',
		label: 'PRF ΔδSQ(OOT)',
		...
		default: false,
		dataType: 'number',
		description: 'The angular offset in the Dec (J2000) direction between the best-fit PRF centroids from the Out-Of-Transit image and the Difference Image by averaging the weighted single-quarter measurements. The out-of-transit centroids are subtracted from the difference image centroids.',
	},
	{
		name: 'koi_dicco_msky',
		label: 'PRF ΔαSQ(KIC)',
		...
		default: false,
		dataType: 'number',
		description: 'The angular offset in the RA (J2000) direction between the best-fit PRF centroids from the difference image and the Kepler Input Catalog position by averaging the weighted single-quarter measurements. The KIC position is subtracted from the difference image centroids.',
	},
	{
		name: 'koi_dikco_mra',
		label: 'PRF ΔαSQ(KIC)',
	...
	},
	{
		...
		default: false,
		dataType: 'number',
		description: 'The angular offset in the Dec (J2000) direction between the best-fit PRF centroids from the difference image and the Kepler Input Catalog position by averaging the weighted single-quarter measurements. The KIC position is subtracted from the difference image centroids.',
	},
	{
		name: 'koi_dikco_msky',
		label: 'PRF ΔθSQ(KIC)',
		...
		default: false,
		dataType: 'number',
		description: 'The angular offset in the plane of the sky between the best-fit PRF centroids from the difference image and the Kepler Input Catalog position by averaging the weighted single-quarter measurements. The KIC position is subtracted from the difference image centroids.',
	},
]
