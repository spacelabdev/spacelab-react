...
import {
	discoveryMethodFiltersArray,
	planetSystemsFiltersArray,
	planetTypeFiltersArray,
	...
	return (
		<>
			...
			<div id={"database-search-wrapper"}>
				...
				<div id="searchBttn"></div>
				<br />

				<div id={"filtersContainer"}>
					<p>Filters</p>
					<DiscoveryFilterList
						filterArray={planetSystemsFiltersArray}
						title={"Planet Systems"}
					/>
					<DiscoveryFilterList
						filterArray={planetTypeFiltersArray}
						title={"Planet Type"}
					/>
					<DiscoveryFilterList
						filterArray={discoveryMethodFiltersArray}
