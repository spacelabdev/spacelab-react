/**
 * Images for home page introduction slider, stored as an array of objects.
 * @type {[{alt: string, id: number, url: string}, {alt: string, id: number, url: string}, {alt: string, id: number, url: string}]}
 */
export const homeSliderImages = [
	...
	},
	{
		...
		alt: "Milky Way over desert rocks",
	},
	{
		id: 3,
