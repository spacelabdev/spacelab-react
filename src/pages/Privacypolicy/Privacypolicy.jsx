	...
	return (
		<>
			...
			<div className="privacy-wrap">
				...
				<br />
				<p>
					This Privacy Policy describes the policies of The
					Spacelab,N/A,CA95060,United States of America (the),email:
					info@spacelab.space, phone: 831-555-5555 on the collection,
					use and disclosure of your information that we collect when
					you use our website ( http://spacelab.space ). (the
				...
				<p>
					...
					rights, you can write to us at info@spacelab.space. We will
					respond to your request in accordance with applicable law.
				</p>
				<br />
				<p>
					You may opt-out of direct marketing communications or the
					profiling we carry out for marketing purposes by writing to
					us at info@spacelab.space.
				</p>
				<br />
				<p>
				...
				<p>
					...
					guarantee absolute security and consequently, we cannot
				...
				<p>
					...
					our Grievance Officer at The Spacelab, N/A, email:
					info@spacelab.space. We will address your concerns in
					accordance with applicable law.
				</p>
				<br />
				<p>
					Privacy Policy generated with{" "}
					<a href="https://www.cookieyes.com/?utm_source=PP&utm_medium=footer&utm_campaign=UW">
						CookieYes
					</a>
					.
				</p>
				...
				<p>
					...
					<a href="https://app.termly.io/notify/84244fc8-3ee5-4874-a964-b5102a61463c">
						{" "}
						Do not sell my info
					</a>
				</p>
				<br />
				<p>
					NOTE: We are using Google Analytics Advertising cookies. We
					and third-party vendors use first-party cookies (such as the
					Google Analytics cookie) or other first-party identifiers,
					and third-party cookies (such as Google advertising cookies)
					or other third-party identifiers in order to inform how we
					should advertise SpaceLab, and so we can make SpaceLab
					better when it appears users are struggling with the website
					or products. You can opt-out of the Google Analytics
					Advertising Features below under Manage Cookie Preferences.
					Also Google Analytics' currently available opt-outs for the
