		...
		<>
			...
			<div className="cookie-wrap">
				...
				<p>
					...
					cookies are mostly necessary for the website to function the
					right way, and they do not collect any of your personally
					identifiable data.
				</p>
				<p>
				...
				<p>
					...
					the above link. This will let you revisit the cookie consent
				...
				<br />
				<p>
					<span style={{ fontWeight: "bold" }}>NOTE:</span> We are
					using Google Analytics Advertising cookies. We and
					third-party vendors use first-party cookies (such as the
				...
				<p>
					...
					<a href="https://www.cookieyes.com/?utm_source=CP&utm_medium=footer&utm_campaign=UW">
